# Proyectos de Uni - C# con Windows Forms
...
1. **Cambiar el valor de una etiqueta**  
   - Descripción: Una aplicación que permite cambiar dinámicamente el texto de una etiqueta (Label) en un formulario al hacer clic en un botón.
...
3. **Índice de masa corporal**  
   - Descripción: Calcula el IMC (Índice de Masa Corporal) ingresando el peso y la altura del usuario, y muestra el resultado con una categoría (bajo peso, normal, sobrepeso, etc.).
...
5. **Hacer un listado**   
   - Descripción: Permite al usuario agregar elementos a una lista (ListBox) y mostrarlos en el formulario.
